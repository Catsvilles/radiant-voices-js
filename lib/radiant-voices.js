(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("radiant-voices", [], factory);
	else if(typeof exports === 'object')
		exports["radiant-voices"] = factory();
	else
		root["radiant-voices"] = factory();
})(this, function() {
...
var _createExtendable = __webpack_require__(339);
...
exports.Stack = exports.OrderedSet = exports.OrderedMap = exports.Set = exports.List = exports.Map = undefined;

var _extendable = __webpack_require__(42);
...
var _OrderedMap = __webpack_require__(344);

var _OrderedMap2 = _interopRequireDefault(_OrderedMap);

var _Set = __webpack_require__(345);

var _Set2 = _interopRequireDefault(_Set);

var _OrderedSet = __webpack_require__(346);

var _OrderedSet2 = _interopRequireDefault(_OrderedSet);

var _Stack = __webpack_require__(347);
...
exports.OrderedMap = _OrderedMap2.default;
exports.OrderedSet = _OrderedSet2.default;
...
var _extendableImmutable = __webpack_require__(48);
...
var Module = function (_Map) {
  _inherits(Module, _Map);
...
var ModuleConnections = function (_Map) {
  _inherits(ModuleConnections, _Map);

  function ModuleConnections() {
    _classCallCheck(this, ModuleConnections);

    return _possibleConstructorReturn(this, (ModuleConnections.__proto__ || Object.getPrototypeOf(ModuleConnections)).apply(this, arguments));
  }

  _createClass(ModuleConnections, null, [{
    key: 'isModuleConnections',
    value: function isModuleConnections(val) {
...
exports.default = ModuleConnections;
module.exports = exports['default'];
...
var Modules = function (_List) {
  _inherits(Modules, _List);

  function Modules() {
    _classCallCheck(this, Modules);

    return _possibleConstructorReturn(this, (Modules.__proto__ || Object.getPrototypeOf(Modules)).apply(this, arguments));
  }

  _createClass(Modules, null, [{
    key: 'isModules',
    value: function isModules(val) {
      return val && val instanceof Modules;
    }
  }]);

  return Modules;
}(_extendableImmutable.List);
...
var OutputModule = function (_Module) {
  _inherits(OutputModule, _Module);

  function OutputModule() {
    _classCallCheck(this, OutputModule);

    return _possibleConstructorReturn(this, (OutputModule.__proto__ || Object.getPrototypeOf(OutputModule)).apply(this, arguments));
  }

  _createClass(OutputModule, null, [{
    key: 'isOutputModule',
    value: function isOutputModule(val) {
...
var Pattern = function (_Map) {
  _inherits(Pattern, _Map);
...
var Patterns = function (_List) {
  _inherits(Patterns, _List);
...
var _Modules = __webpack_require__(130);

var _Modules2 = _interopRequireDefault(_Modules);

var _ModuleConnections = __webpack_require__(129);

var _ModuleConnections2 = _interopRequireDefault(_ModuleConnections);

var _OutputModule = __webpack_require__(131);

var _OutputModule2 = _interopRequireDefault(_OutputModule);

var _Patterns = __webpack_require__(133);
...
var Project = function (_Map) {
  _inherits(Project, _Map);
  ...
  _createClass(Project, [{
    ...
    key: 'modulesLayerMask',
    get: function get() {
      return this.get('modulesLayerMask');
    }
  }, {
    key: 'modulesCurrentLayer',
    get: function get() {
    ...
    value: function empty() {
      var outputModule = new _OutputModule2.default();
      return new Project().merge({
        initialized: true,
        modules: new _Modules2.default([outputModule]),
        moduleConnections: new _ModuleConnections2.default(),
        outputModule: outputModule,
        patterns: new _Patterns2.default(),
...
var _Module = __webpack_require__(93);

var _Module2 = _interopRequireDefault(_Module);

var _Pattern = __webpack_require__(132);

var _Pattern2 = _interopRequireDefault(_Pattern);

var _Project = __webpack_require__(134);

var _Project2 = _interopRequireDefault(_Project);

var _moduleChunks = __webpack_require__(348);

var _moduleChunks2 = _interopRequireDefault(_moduleChunks);

var _patternChunks = __webpack_require__(349);

var _patternChunks2 = _interopRequireDefault(_patternChunks);

var _projectChunks = __webpack_require__(350);

var _projectChunks2 = _interopRequireDefault(_projectChunks);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function chunks(obj) {
  if (_Module2.default.isModule(obj)) {
    return (0, _moduleChunks2.default)(obj);
  } else if (_Pattern2.default.isPattern(obj)) {
    return (0, _patternChunks2.default)(obj);
  } else if (_Project2.default.isProject(obj)) {
    return (0, _projectChunks2.default)(obj);
  }
}
module.exports = exports['default'];
...
exports.chunks = exports.Project = exports.Patterns = exports.Pattern = exports.OutputModule = exports.Modules = exports.ModuleConnections = exports.Module = undefined;
...
var _chunks = __webpack_require__(135);
...
exports.ModuleConnections = _ModuleConnections2.default;
exports.Modules = _Modules2.default;
exports.OutputModule = _OutputModule2.default;
exports.Pattern = _Pattern2.default;
exports.Patterns = _Patterns2.default;
exports.Project = _Project2.default;
exports.chunks = _chunks2.default;
...
var _startsWith = __webpack_require__(341);
...
var startsWith = function startsWith(str, needle) {
...
exports.default = (0, _extendable2.default)(_immutable.Map);
...
exports.default = (0, _extendable2.default)(_immutable.List);
...
exports.default = (0, _extendable2.default)(_immutable.OrderedMap);
...
exports.default = (0, _extendable2.default)(_immutable.Set);
...
exports.default = (0, _extendable2.default)(_immutable.OrderedSet);
...
exports.default = (0, _extendable2.default)(_immutable.Stack);
...
exports.default = moduleChunks;

var _marked = /*#__PURE__*/regeneratorRuntime.mark(moduleChunks);

function moduleChunks(module) {
        return regeneratorRuntime.wrap(function moduleChunks$(_context) {
                while (1) {
...
exports.default = patternChunks;

var _marked = /*#__PURE__*/regeneratorRuntime.mark(patternChunks);

function patternChunks(pattern) {
  return regeneratorRuntime.wrap(function patternChunks$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
        case "end":
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(projectChunks);

function projectChunks(project) {
  var magicChunk, sunvoxVersion, basedOnVersion, initialBpm, initialTpl, timeGrid, globalVolume, name, modulesScale, modulesZoom, modulesXOffset, modulesYOffset, modulesLayerMask, modulesCurrentLayer, timelinePosition, selectedModule, currentPattern, currentTrack, currentLine, patterns, modules, pattern, chunk, module, _chunk;

  return regeneratorRuntime.wrap(function projectChunks$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          magicChunk = project.magicChunk, sunvoxVersion = project.sunvoxVersion, basedOnVersion = project.basedOnVersion, initialBpm = project.initialBpm, initialTpl = project.initialTpl, timeGrid = project.timeGrid, globalVolume = project.globalVolume, name = project.name, modulesScale = project.modulesScale, modulesZoom = project.modulesZoom, modulesXOffset = project.modulesXOffset, modulesYOffset = project.modulesYOffset, modulesLayerMask = project.modulesLayerMask, modulesCurrentLayer = project.modulesCurrentLayer, timelinePosition = project.timelinePosition, selectedModule = project.selectedModule, currentPattern = project.currentPattern, currentTrack = project.currentTrack, currentLine = project.currentLine, patterns = project.patterns, modules = project.modules;
          _context.next = 3;
          return { type: magicChunk };

        case 3:
          _context.next = 5;
          return {
            type: 'VERS', data: {
              bytes: [sunvoxVersion[3], sunvoxVersion[2], sunvoxVersion[1], sunvoxVersion[0]]
            }
          };
        ...
        case 5:
          ...
          return {
            type: 'BVER', data: {
              bytes: [basedOnVersion[3], basedOnVersion[2], basedOnVersion[1], basedOnVersion[0]]
            }
          };

        case 7:
          _context.next = 9;
          return { type: 'BPM ', data: { uint32: initialBpm } };

        case 9:
          _context.next = 11;
          return { type: 'SPED', data: { uint32: initialTpl } };

        case 11:
          _context.next = 13;
          return { type: 'TGRD', data: { uint32: timeGrid } };

        case 13:
          _context.next = 15;
          return { type: 'GVOL', data: { uint32: globalVolume } };

        case 15:
          _context.next = 17;
          return { type: 'NAME', data: { cstring: name } };

        case 17:
          _context.next = 19;
          return { type: 'MSCL', data: { uint32: modulesScale } };

        case 19:
          _context.next = 21;
          return { type: 'MZOO', data: { uint32: modulesZoom } };

        case 21:
          _context.next = 23;
          return { type: 'MXOF', data: { int32: modulesXOffset } };

        case 23:
          _context.next = 25;
          return { type: 'MYOF', data: { int32: modulesYOffset } };

        case 25:
          _context.next = 27;
          return { type: 'LMSK', data: { uint32: modulesLayerMask } };

        case 27:
          _context.next = 29;
          return { type: 'CURL', data: { uint32: modulesCurrentLayer } };

        case 29:
          _context.next = 31;
          return { type: 'TIME', data: { int32: timelinePosition } };

        case 31:
          _context.next = 33;
          return { type: 'SELS', data: { uint32: selectedModule } };

        case 33:
          _context.next = 35;
          return { type: 'LGEN', data: { bytes: [1, 0, 0, 0] } };

        case 35:
          _context.next = 37;
          return { type: 'PATN', data: { uint32: currentPattern } };

        case 37:
          _context.next = 39;
          return { type: 'PATT', data: { uint32: currentTrack } };

        case 39:
          _context.next = 41;
          return { type: 'PATL', data: { uint32: currentLine } };

        case 41:
          _context.t0 = regeneratorRuntime.keys(patterns);
        ...
        case 42:
          ...
          pattern = _context.t1.value;
          _context.t2 = regeneratorRuntime.keys((0, _2.default)(pattern));
        ...
        case 55:
          _context.t4 = regeneratorRuntime.keys(modules);
        ...
        case 56:
          ...
          module = _context.t5.value;
          _context.t6 = regeneratorRuntime.keys((0, _2.default)(module));
...
//# sourceMappingURL=radiant-voices.js.map